...
MODEL_OPTIONS = {
    ...
    "DeepSeek R1 70B — Groq": {
        "provider": "groq",
        "fast_model": "deepseek-r1-distill-llama-70b",
        "smart_model": "deepseek-r1-distill-llama-70b",
        "env_key": "GROQ_API_KEY",
        "key_label": "Groq API Key",
        "key_help": "Free at console.groq.com → API Keys",
        "note": "Reasoning-focused · strong on compliance logic",
    },
    "Gemma 2 9B — Groq": {
        "provider": "groq",
        "fast_model": "gemma2-9b-it",
        "smart_model": "gemma2-9b-it",
        "env_key": "GROQ_API_KEY",
        "key_label": "Groq API Key",
        "key_help": "Free at console.groq.com → API Keys",
        "note": "Google open model · highest free-tier rate limits",
    },
    "Mixtral 8x7B — Groq": {
        "provider": "groq",
        ...
        "key_label": "Groq API Key",
        "key_help": "Free at console.groq.com → API Keys",
        "note": "Mixture-of-experts · long 32k context window",
    },
    # ── Cerebras (free — cloud.cerebras.ai) ───────────────────────────────────
    "Llama 3.3 70B — Cerebras": {
        "provider": "cerebras",
        "fast_model": "llama3.1-8b",
        "smart_model": "llama3.3-70b",
        "env_key": "CEREBRAS_API_KEY",
        "key_label": "Cerebras API Key",
        "key_help": "Free at cloud.cerebras.ai → API Keys",
        "note": "8B evaluators · 70B refiner · world's fastest inference",
    },
    "Llama 3.1 8B — Cerebras": {
        ...
        "key_label": "Cerebras API Key",
        "key_help": "Free at cloud.cerebras.ai → API Keys",
        "note": "Fastest model available · good for demos",
    },
    ...
    "Llama 3.3 70B — SambaNova": {
        ...
        "note": "8B evaluators · 70B refiner · no rate limit issues",
    },
    "DeepSeek R1 — SambaNova": {
        ...
        "key_label": "SambaNova API Key",
        "key_help": "Free at cloud.sambanova.ai → API Keys",
        "note": "Full DeepSeek R1 671B refiner · best reasoning available free",
    },
    "Qwen 2.5 72B — SambaNova": {
        ...
        "key_label": "SambaNova API Key",
        "key_help": "Free at cloud.sambanova.ai → API Keys",
        "note": "Alibaba open model · excellent instruction following",
    },
    # ── Ollama (local — no key) ────────────────────────────────────────────────
    "Ollama (local)": {
        "provider": "ollama",
